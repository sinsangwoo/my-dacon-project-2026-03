...
echo ""
echo "================================================================"
echo "🛡️  STEP 1/5: DINOv2 & CLIP 특징 추출 (DINOv2+CLIP)"
echo "================================================================"
python src/extract_features.py --model all | tee -a $LOG_FILE
if [ $? -eq 0 ]; then
...
echo ""
echo "================================================================"
echo "🧠  STEP 2/5: LightGBM 학습 및 하이퍼파라미터 튜닝"
echo "================================================================"
python src/train_lgbm.py --feature all --n_trials 50 | tee -a $LOG_FILE
if [ $? -eq 0 ]; then
...
echo ""
echo "================================================================"
echo "🔥  STEP 3/5: Dual-Stream EfficientNet 학습 (가장 오래 걸림)"
echo "================================================================"
python -u src/train.py --epochs 20 --batch_size 16 --resume 2>&1 | tee -a $LOG_FILE
if [ $? -eq 0 ]; then
...
echo ""
echo "================================================================"
echo "🔮  STEP 4/5: 학습된 딥러닝 모델로 테스트 데이터 추론"
echo "================================================================"
python src/predict.py | tee -a $LOG_FILE
if [ $? -eq 0 ]; then
...
echo ""
echo "================================================================"
echo "🧬  STEP 5/5: 최종 결과 앙상블 및 제출 파일 생성"
echo "================================================================"
python src/ensemble.py --method geometric --output_csv final_submission.csv | tee -a $LOG_FILE
if [ $? -eq 0 ]; then
